...
import de.andreasgerhard.maven.wagon.auth.AwsCredentials;
import de.andreasgerhard.maven.wagon.auth.AwsSessionCredentials;
import de.andreasgerhard.maven.wagon.auth.MavenAwsCredentialsProviderChain;
